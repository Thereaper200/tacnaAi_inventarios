...
$sql = "SELECT oficina, lapiz FROM inventarios_diarios WHERE fecha IN (SELECT MAX(fecha) FROM inventarios_diarios GROUP BY oficina)";
...
// Título del gráfico
$grafico->title->Set("Inventarios Diarios de Lápices");

// Título del eje X
$grafico->xaxis->title->Set("Oficinas");

// Título del eje Y
//$grafico->yaxis->title->Set("Cantidad de Lápices");
