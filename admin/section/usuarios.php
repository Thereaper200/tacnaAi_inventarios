        ...
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $txtNombreSelec; ?>" name="txtNombre" id="txtNombre" placeholder="Usuario" pattern="[a-zA-Z0-9,]*{0,32}" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="txtContra">Contraseña:</label>
                    <input type="text" class="form-control"  name="txtContra" id="txtContra" placeholder="Contraseña" autocomplete="off">
                </div>
